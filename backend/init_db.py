...
DEFAULT_PAGES = {
    ...
    "members": {
        ...
        "content": {
            ...
            "members": [
                {"name": "张三", "role": "产品负责人", "group": "流光组", "avatar": "", "description": "专注于产品战略与用户体验设计", "skills": ["产品设计", "用户研究", "项目管理"], "links": {"github": "", "portfolio": ""}},
                {"name": "李四", "role": "技术负责人", "group": "逐云组", "avatar": "", "description": "全栈工程师，热衷于开源项目", "skills": ["Vue", "Python", "DevOps"], "links": {"github": "", "portfolio": ""}},
                {"name": "王五", "role": "设计负责人", "group": "星绘组", "avatar": "", "description": "UI/UX 设计师，追求像素完美", "skills": ["UI设计", "品牌设计", "动效设计"], "links": {"github": "", "portfolio": ""}}
            ],
            "stats": [
                {"value": "12+", "label": "核心成员"},
    ...
    "open-source": {
        ...
        "content": {
            ...
            "community": {
                ...
                "github": "https://github.com/xingyu-studio"
            }
        }
    },
    "timeline": {
    ...
    "yuji": {
        ...
        "content": {
            ...
            "cta": {
                "title": "在 GitHub 上查看",
                "link": "https://github.com/xingyu-studio/yuji"
            }
        }
    }
}
